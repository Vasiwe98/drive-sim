...
`;ki.innerHTML='<div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-12 02:55</div>';document.body.appendChild(ki);const Jv=ki.querySelector("#hud-camera"),Qv=ki.querySelector("#hud-speed"),tr={isStarted:()=>li,setCameraMode:s=>{Jv.textContent=`camera: ${s}`},setSpeed:s=>{Qv.textContent=`${Math.round(s)} km/h`}},tx="2026-05-11-sink-fix-v12b-manual-raytest";let ei=null,Yl=0;function ex(s=!1){return s||new URLSearchParams(location.search).has("debug")?(ei=document.createElement("div"),ei.id="debug-panel",ei.style.cssText=`
