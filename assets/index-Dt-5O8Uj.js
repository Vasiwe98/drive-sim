...
`;ki.innerHTML='<div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-11 23:21</div>';document.body.appendChild(ki);const Zv=ki.querySelector("#hud-camera"),Jv=ki.querySelector("#hud-speed"),tr={isStarted:()=>ai,setCameraMode:o=>{Zv.textContent=`camera: ${o}`},setSpeed:o=>{Jv.textContent=`${Math.round(o)} km/h`}},Qv="2026-05-11-sink-fix-v5-no-collider-offset";let ei=null,Yl=0;function tx(o=!1){return o||new URLSearchParams(location.search).has("debug")?(ei=document.createElement("div"),ei.id="debug-panel",ei.style.cssText=`
