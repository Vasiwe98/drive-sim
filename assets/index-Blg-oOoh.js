...
`;Vi.innerHTML='<div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-11 05:46</div>';document.body.appendChild(Vi);const Fv=Vi.querySelector("#hud-camera"),Ov=Vi.querySelector("#hud-speed"),Qr={isStarted:()=>oi,setCameraMode:r=>{Fv.textContent=`camera: ${r}`},setSpeed:r=>{Ov.textContent=`${Math.round(r)} km/h`}};let ti=null,Xl=0;function Bv(r=!1){return r||new URLSearchParams(location.search).has("debug")?(ti=document.createElement("div"),ti.id="debug-panel",ti.style.cssText=`
