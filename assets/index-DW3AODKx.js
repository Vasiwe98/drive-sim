...
`;Vi.innerHTML='<div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-11 22:21</div>';document.body.appendChild(Vi);const Zv=Vi.querySelector("#hud-camera"),Jv=Vi.querySelector("#hud-speed"),tr={isStarted:()=>ai,setCameraMode:o=>{Zv.textContent=`camera: ${o}`},setSpeed:o=>{Jv.textContent=`${Math.round(o)} km/h`}},Qv="2026-05-11-sink-fix-v3";let ei=null,Yl=0;function tx(o=!1){return o||new URLSearchParams(location.search).has("debug")?(ei=document.createElement("div"),ei.id="debug-panel",ei.style.cssText=`
