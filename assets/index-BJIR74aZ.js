...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function hl(){return new oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function ul(){return new oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cc(),fragmentShader:`
	...
	`}function wg(r){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===pa||c===ma,h=c===is||c===ss;if(l||h){let u=e.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new cl(r)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return l&&f&&f.height>0||h&&f&&i(f)?(t===null&&(t=new cl(r)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function i(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function bg(r){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Gr("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Ag(r,e,t,n){const i={},s=new WeakMap;function o(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)e.remove(_[p])}d.removeEventListener("dispose",o),delete i[d.id];const f=s.get(d);f&&(e.remove(f),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const g in d)e.update(d[g],r.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)e.update(_[p],r.ARRAY_BUFFER)}}function l(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const x=f.array;_=f.version;for(let y=0,E=x.length;y<E;y+=3){const C=x[y+0],b=x[y+1],w=x[y+2];d.push(C,b,b,w,w,C)}}else if(g!==void 0){const x=g.array;_=g.version;for(let y=0,E=x.length/3-1;y<E;y+=3){const C=y+0,b=y+1,w=y+2;d.push(C,b,b,w,w,C)}}else return;const p=new(nu(d)?cu:au)(d,1);p.version=_;const m=s.get(u);m&&e.remove(m),s.set(u,p)}function h(u){const d=s.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return s.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function Rg(r,e,t){let n;function i(d){n=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function c(d,f){r.drawElements(n,f,s,d*o),t.update(f,n,1)}function l(d,f,g){g!==0&&(r.drawElementsInstanced(n,f,s,d*o,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,s,d,0,g);let p=0;for(let m=0;m<g;m++)p+=f[m];t.update(p,n,1)}function u(d,f,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<d.length;m++)l(d[m]/o,f[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,s,d,0,_,0,g);let m=0;for(let x=0;x<g;x++)m+=f[x];for(let x=0;x<_.length;x++)t.update(m,n,_[x])}}this.setMode=i,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Cg(r){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case r.TRIANGLES:t.triangles+=a*(s/3);break;case r.LINES:t.lines+=a*(s/2);break;case r.LINE_STRIP:t.lines+=a*(s-1);break;case r.LINE_LOOP:t.lines+=a*s;break;case r.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Pg(r,e,t){const n=new WeakMap,i=new Ze;function s(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let v=function(){R.dispose(),n.delete(a),a.removeEventListener("dispose",v)};var f=v;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],x=a.morphAttributes.normal||[],y=a.morphAttributes.color||[];let E=0;g===!0&&(E=1),_===!0&&(E=2),p===!0&&(E=3);let C=a.attributes.position.count*E,b=1;C>e.maxTextureSize&&(b=Math.ceil(C/e.maxTextureSize),C=e.maxTextureSize);const w=new Float32Array(C*b*4*u),R=new su(w,C,b,u);R.type=hn,R.needsUpdate=!0;const U=E*4;for(let S=0;S<u;S++){const D=m[S],P=x[S],N=y[S],F=C*b*4*S;for(let I=0;I<D.count;I++){const k=I*U;g===!0&&(i.fromBufferAttribute(D,I),w[F+k+0]=i.x,w[F+k+1]=i.y,w[F+k+2]=i.z,w[F+k+3]=0),_===!0&&(i.fromBufferAttribute(P,I),w[F+k+4]=i.x,w[F+k+5]=i.y,w[F+k+6]=i.z,w[F+k+7]=0),p===!0&&(i.fromBufferAttribute(N,I),w[F+k+8]=i.x,w[F+k+9]=i.y,w[F+k+10]=i.z,w[F+k+11]=N.itemSize===4?i.w:1)}}d={count:u,texture:R,size:new Re(C,b)},n.set(a,d),a.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(r,"morphTexture",o.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(r,"morphTargetBaseInfluence",_),c.getUniforms().setValue(r,"morphTargetInfluences",l)}c.getUniforms().setValue(r,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(r,"morphTargetsTextureSize",d.size)}return{update:s}}function Lg(r,e,t,n){let i=new WeakMap;function s(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),i.get(c)!==l&&(t.update(c.instanceMatrix,r.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,r.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;i.get(d)!==l&&(d.update(),i.set(d,l))}return u}function o(){i=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class fu extends St{constructor(e,t,n,i,s,o,a,c,l,h=Qi){if(h!==Qi&&h!==as)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Qi&&(n=Ti),n===void 0&&h===as&&(n=os),super(null,i,s,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Ot,this.minFilter=c!==void 0?c:Ot,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const pu=new St,dl=new fu(1,1),mu=new su,gu=new _f,_u=new uu,fl=[],pl=[],ml=new Float32Array(16),gl=new Float32Array(9),_l=new Float32Array(4);function ps(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let s=fl[i];if(s===void 0&&(s=new Float32Array(i),fl[i]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,r[o].toArray(s,a)}return s}function vt(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function yt(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function eo(r,e){let t=pl[e];t===void 0&&(t=new Int32Array(e),pl[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function Ig(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function Dg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;r.uniform2fv(this.addr,e),yt(t,e)}}function Ng(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(vt(t,e))return;r.uniform3fv(this.addr,e),yt(t,e)}}function Ug(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;r.uniform4fv(this.addr,e),yt(t,e)}}function Fg(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),yt(t,e)}else{if(vt(t,n))return;_l.set(n),r.uniformMatrix2fv(this.addr,!1,_l),yt(t,n)}}function Og(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),yt(t,e)}else{if(vt(t,n))return;gl.set(n),r.uniformMatrix3fv(this.addr,!1,gl),yt(t,n)}}function Bg(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),yt(t,e)}else{if(vt(t,n))return;ml.set(n),r.uniformMatrix4fv(this.addr,!1,ml),yt(t,n)}}function zg(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function kg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;r.uniform2iv(this.addr,e),yt(t,e)}}function Hg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;r.uniform3iv(this.addr,e),yt(t,e)}}function Vg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;r.uniform4iv(this.addr,e),yt(t,e)}}function Gg(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function Wg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;r.uniform2uiv(this.addr,e),yt(t,e)}}function Xg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;r.uniform3uiv(this.addr,e),yt(t,e)}}function qg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;r.uniform4uiv(this.addr,e),yt(t,e)}}function Yg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(dl.compareFunction=eu,s=dl):s=pu,t.setTexture2D(e||s,i)}function jg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||gu,i)}function Kg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||_u,i)}function $g(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||mu,i)}function Zg(r){switch(r){case 5126:return Ig;case 35664:return Dg;case 35665:return Ng;case 35666:return Ug;case 35674:return Fg;case 35675:return Og;case 35676:return Bg;case 5124:case 35670:return zg;case 35667:case 35671:return kg;case 35668:case 35672:return Hg;case 35669:case 35673:return Vg;case 5125:return Gg;case 36294:return Wg;case 36295:return Xg;case 36296:return qg;case 35678:case 36198:case 36298:case 36306:case 35682:return Yg;case 35679:case 36299:case 36307:return jg;case 35680:case 36300:case 36308:case 36293:return Kg;case 36289:case 36303:case 36311:case 36292:return $g}}function Jg(r,e){r.uniform1fv(this.addr,e)}function Qg(r,e){const t=ps(e,this.size,2);r.uniform2fv(this.addr,t)}function e_(r,e){const t=ps(e,this.size,3);r.uniform3fv(this.addr,t)}function t_(r,e){const t=ps(e,this.size,4);r.uniform4fv(this.addr,t)}function n_(r,e){const t=ps(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function i_(r,e){const t=ps(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function s_(r,e){const t=ps(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function r_(r,e){r.uniform1iv(this.addr,e)}function o_(r,e){r.uniform2iv(this.addr,e)}function a_(r,e){r.uniform3iv(this.addr,e)}function c_(r,e){r.uniform4iv(this.addr,e)}function l_(r,e){r.uniform1uiv(this.addr,e)}function h_(r,e){r.uniform2uiv(this.addr,e)}function u_(r,e){r.uniform3uiv(this.addr,e)}function d_(r,e){r.uniform4uiv(this.addr,e)}function f_(r,e,t){const n=this.cache,i=e.length,s=eo(t,i);vt(n,s)||(r.uniform1iv(this.addr,s),yt(n,s));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||pu,s[o])}function p_(r,e,t){const n=this.cache,i=e.length,s=eo(t,i);vt(n,s)||(r.uniform1iv(this.addr,s),yt(n,s));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||gu,s[o])}function m_(r,e,t){const n=this.cache,i=e.length,s=eo(t,i);vt(n,s)||(r.uniform1iv(this.addr,s),yt(n,s));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||_u,s[o])}function g_(r,e,t){const n=this.cache,i=e.length,s=eo(t,i);vt(n,s)||(r.uniform1iv(this.addr,s),yt(n,s));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||mu,s[o])}function __(r){switch(r){case 5126:return Jg;case 35664:return Qg;case 35665:return e_;case 35666:return t_;case 35674:return n_;case 35675:return i_;case 35676:return s_;case 5124:case 35670:return r_;case 35667:case 35671:return o_;case 35668:case 35672:return a_;case 35669:case 35673:return c_;case 5125:return l_;case 36294:return h_;case 36295:return u_;case 36296:return d_;case 35678:case 36198:case 36298:case 36306:case 35682:return f_;case 35679:case 36299:case 36307:return p_;case 35680:case 36300:case 36308:case 36293:return m_;case 36289:case 36303:case 36311:case 36292:return g_}}class x_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Zg(t.type)}}class v_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=__(t.type)}}class y_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,o=i.length;s!==o;++s){const a=i[s];a.setValue(e,t[a.id],n)}}}const Oo=/(\w+)(\])?(\[|\.)?/g;function xl(r,e){r.seq.push(e),r.map[e.id]=e}function M_(r,e,t){const n=r.name,i=n.length;for(Oo.lastIndex=0;;){const s=Oo.exec(n),o=Oo.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===i){xl(t,l===void 0?new x_(a,r,e):new v_(a,r,e));break}else{let u=t.map[a];u===void 0&&(u=new y_(a),xl(t,u)),t=u}}}class Wr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=e.getActiveUniform(t,i),o=e.getUniformLocation(t,s.name);M_(s,o,this)}}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function vl(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const S_=37297;let E_=0;function T_(r,e){const t=r.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=i;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function w_(r){const e=je.getPrimaries(je.workingColorSpace),t=je.getPrimaries(r);let n;switch(e===t?n="":e===jr&&t===Yr?n="LinearDisplayP3ToLinearSRGB":e===Yr&&t===jr&&(n="LinearSRGBToLinearDisplayP3"),r){case bt:case Qr:return[n,"LinearTransferOETF"];case Ut:case sc:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function yl(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),i=r.getShaderInfoLog(e).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+i+`

`+T_(r.getShaderSource(e),o)}else return i}function b_(r,e){const t=w_(e);return`vec4 ${r}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function A_(r,e){let t;switch(e){case wd:t="Linear";break;case bd:t="Reinhard";break;case Ad:t="Cineon";break;case Rd:t="ACESFilmic";break;case Pd:t="AgX";break;case Ld:t="Neutral";break;case Cd:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const yr=new O;function R_(){je.getLuminanceCoefficients(yr);const r=yr.x.toFixed(4),e=yr.y.toFixed(4),t=yr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function O_(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Bh?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===zh?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Bn&&(e="SHADOWMAP_TYPE_VSM"),e}function B_(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case is:case ss:e="ENVMAP_TYPE_CUBE";break;case Jr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function z_(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case ss:e="ENVMAP_MODE_REFRACTION";break}return e}function k_(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case kh:e="ENVMAP_BLENDING_MULTIPLY";break;case Ed:e="ENVMAP_BLENDING_MIX";break;case Td:e="ENVMAP_BLENDING_ADD";break}return e}function H_(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function V_(r,e,t,n){const i=r.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=O_(t),l=B_(t),h=z_(t),u=k_(t),d=H_(t),f=C_(t),g=P_(s),_=i.createProgram();let p,m,x=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Ns).join(`
`)),o=Wa(o),o=Ml(o,t),o=Sl(o,t),a=Wa(a),a=Ml(a,t),a=Sl(a,t),o=El(o),a=El(a),t.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`)+`
`+m);const y=x+p+o,E=x+m+a,C=vl(i,i.VERTEX_SHADER,y),b=vl(i,i.FRAGMENT_SHADER,E);i.attachShader(_,C),i.attachShader(_,b),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(S){if(r.debug.checkShaderErrors){const D=i.getProgramInfoLog(_).trim(),P=i.getShaderInfoLog(C).trim(),N=i.getShaderInfoLog(b).trim();let F=!0,I=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(F=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,b);else{const k=yl(i,C,"vertex"),z=yl(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`;Pi.innerHTML='<div id="hud-vehicle" style="font-weight:600;letter-spacing:0.5px;">Porsche 911</div><div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-12 13:24</div>';document.body.appendChild(Pi);const US=Pi.querySelector("#hud-vehicle"),FS=Pi.querySelector("#hud-camera"),OS=Pi.querySelector("#hud-speed"),Hs={isStarted:()=>Ai,setCameraMode:r=>{FS.textContent=`camera: ${r}`},setSpeed:r=>{OS.textContent=`${Math.round(r)} km/h`},setVehicleName:r=>{US.textContent=r}},BS="2026-05-12-ramp-velocity-and-pitch-v15";let Si=null,Nh=0;function zS(r=!1){return r||new URLSearchParams(location.search).has("debug")?(Si=document.createElement("div"),Si.id="debug-panel",Si.style.cssText=`
  ...
  `,document.body.appendChild(Si),Si):null}function kS(r){if(!Si)return;const e=performance.now();if(e-Nh<100)return;Nh=e;const t=r.chassisBody,n=r.vehicle,i=n.wheelInfos.map(d=>d.raycastResult.body?1:0),s=i.reduce((d,f)=>d+f,0),o=n.wheelInfos.map(d=>d.engineForce|0),a=n.wheelInfos.map(d=>d.suspensionForce|0),c=n.wheelInfos.map(d=>d.suspensionLength.toFixed(2)),l=n.wheelInfos.map(d=>{const f=d.__diag;if(!f)return"?";const g=f.rejected?"X":f.rawHit?"H":"-";return g==="-"?g:`${g}d${f.rawDist.toFixed(2)}n${f.rawNormY>=0?"+":""}${f.rawNormY.toFixed(1)}`}),h=n.wheelInfos[0].__diag?n.wheelInfos[0].__diag.srcY.toFixed(2):"?",u=n.wheelInfos[0].__diag?n.wheelInfos[0].__diag.tgtY.toFixed(2):"?";Si.textContent=`build ${BS}
...
P=physics wireframe  ?spawn=deck`}const HS=document.getElementById("game"),{scene:so,camera:Ku,renderer:VS,controls:GS,setTimeOfDay:$u}=yM(HS),{world:Sc,step:WS}=MM(),Ka=Mc();$u(Ka.time);const Ys=new yn;so.add(Ys);const Uh=new nM(Ys,Sc,{color:16711935});Ys.visible=!1;wS("KeyP",()=>{Ys.visible=!Ys.visible});const{spawnPos:XS,ramps:qS}=uS(so,Sc),YS=new URLSearchParams(location.search).get("spawn"),Zu=YS==="deck"?new M(0,5,-70):XS,Ct=oS(Sc,so,Zu,Ka.color,Ka.style),Fh=TS(Ct,qS,io);Hs.setVehicleName(Ct.getProfileName());PS(r=>{Ct.setColor(r.color),Ct.setBodyStyle(r.style),$u(r.time),Hs.setVehicleName(Ct.getProfileName())});const Fs=new mS(Ku,GS);Fs.setTarget(Ct.chassisBody);zS(!0);const jS=Math.PI/2,KS=new M(0,1,0);function Ec(){Ct.chassisBody.position.copy(Zu),Ct.chassisBody.velocity.setZero(),Ct.chassisBody.angularVelocity.setZero(),Ct.chassisBody.quaternion.setFromAxisAngle(KS,jS);for(const r of Ct.vehicle.wheelInfos)r.steering=0,r.rotation=0,r.brake=0,r.engineForce=0;Ct.setSuspendVehicleControl(!1)}Ec();DS(Ec);IS(Ec);let Oh=-1;const $S=new J0;function Ju(){const r=Math.min($S.getDelta(),.1);Hs.isStarted()&&(Fh.update(r),Ct.applyInput(io)),WS(r),Ct.syncMeshes(Fh.getOverride()),Fs.update(r),Fs.mode!==Oh&&(Oh=Fs.mode,Hs.setCameraMode(Fs.getModeName())),Hs.setSpeed(Ct.getSpeedKmh()),kS(Ct),Uh&&Uh.update(),VS.render(so,Ku),requestAnimationFrame(Ju)}Ju();
