...
#define LOW_PRECISION`),t}function ym(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Zl?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===Jl?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===yn&&(t="SHADOWMAP_TYPE_VSM"),t}function Mm(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Fi:case Oi:t="ENVMAP_TYPE_CUBE";break;case io:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Sm(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Oi:t="ENVMAP_MODE_REFRACTION";break}return t}function Em(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case Ql:t="ENVMAP_BLENDING_MULTIPLY";break;case Sh:t="ENVMAP_BLENDING_MIX";break;case Eh:t="ENVMAP_BLENDING_ADD";break}return t}function wm(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function bm(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const l=ym(e),c=Mm(e),h=Sm(e),d=Em(e),u=wm(e),m=dm(e),_=fm(s),v=i.createProgram();let f,p,x=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const S=x+f+r,E=x+p+a,L=Ja(i,i.VERTEX_SHADER,S),A=Ja(i,i.FRAGMENT_SHADER,E);i.attachShader(v,L),i.attachShader(v,A),e.index0AttributeName!==void 0?i.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function T(M){if(o.debug.checkShaderErrors){const U=i.getProgramInfoLog(v).trim(),R=i.getShaderInfoLog(L).trim(),D=i.getShaderInfoLog(A).trim();let F=!0,I=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(F=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(i,v,L,A);else{const Y=Qa(i,L,"vertex"),V=Qa(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
`;ki.innerHTML='<div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-11 13:28</div>';document.body.appendChild(ki);const Zv=ki.querySelector("#hud-camera"),Jv=ki.querySelector("#hud-speed"),tr={isStarted:()=>ai,setCameraMode:o=>{Zv.textContent=`camera: ${o}`},setSpeed:o=>{Jv.textContent=`${Math.round(o)} km/h`}};let ei=null,Yl=0;function Qv(o=!1){return o||new URLSearchParams(location.search).has("debug")?(ei=document.createElement("div"),ei.id="debug-panel",ei.style.cssText=`
...
mass ${e.mass}  sleeping ${e.sleepState}`}const ex=document.getElementById("game"),{scene:lo,camera:jc,renderer:nx,controls:ix}=Sv(ex),{world:oa,step:sx}=Ev(),ox=new URLSearchParams(location.search).has("debug"),jl=ox?new rv(lo,oa,{color:16711935}):null,{spawnPos:Kc,ramps:rx}=Nv(lo,oa),We=Cv(oa,lo,Kc),Kl=qv(We,rx,ao),es=new Bv(jc,ix);es.setTarget(We.chassisBody);Qv(!0);function $c(){We.chassisBody.position.copy(Kc),We.chassisBody.velocity.setZero(),We.chassisBody.angularVelocity.setZero(),We.chassisBody.quaternion.set(0,0,0,1);for(const o of We.vehicle.wheelInfos)o.steering=0,o.rotation=0,o.brake=0,o.engineForce=0;We.setSuspendVehicleControl(!1)}Kv($c);jv($c);let $l=-1;const ax=new h_;function Zc(){const o=Math.min(ax.getDelta(),.1);tr.isStarted()&&(Kl.update(o),We.applyInput(ao)),sx(o),We.syncMeshes(Kl.getOverride()),es.update(o),es.mode!==$l&&($l=es.mode,tr.setCameraMode(es.getModeName())),tr.setSpeed(We.getSpeedKmh()),tx(We),jl&&jl.update(),nx.render(lo,jc),requestAnimationFrame(Zc)}Zc();
