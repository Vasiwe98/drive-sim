...
`;Pi.innerHTML='<div id="hud-vehicle" style="font-weight:600;letter-spacing:0.5px;">Porsche 911</div><div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-12 13:05</div>';document.body.appendChild(Pi);const US=Pi.querySelector("#hud-vehicle"),FS=Pi.querySelector("#hud-camera"),OS=Pi.querySelector("#hud-speed"),Hs={isStarted:()=>Ai,setCameraMode:r=>{FS.textContent=`camera: ${r}`},setSpeed:r=>{OS.textContent=`${Math.round(r)} km/h`},setVehicleName:r=>{US.textContent=r}},BS="2026-05-12-ramp-velocity-and-pitch-v15";let Si=null,Nh=0;function zS(r=!1){return r||new URLSearchParams(location.search).has("debug")?(Si=document.createElement("div"),Si.id="debug-panel",Si.style.cssText=`
