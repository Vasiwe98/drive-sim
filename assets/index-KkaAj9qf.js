...
`;ki.innerHTML='<div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-11 07:06</div>';document.body.appendChild(ki);const Bv=ki.querySelector("#hud-camera"),zv=ki.querySelector("#hud-speed"),Qr={isStarted:()=>ri,setCameraMode:r=>{Bv.textContent=`camera: ${r}`},setSpeed:r=>{zv.textContent=`${Math.round(r)} km/h`}};let Qn=null,Wl=0;function Hv(r=!1){return r||new URLSearchParams(location.search).has("debug")?(Qn=document.createElement("div"),Qn.id="debug-panel",Qn.style.cssText=`
