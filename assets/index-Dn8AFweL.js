...
`)+`
`+m);const S=x+f+r,E=x+m+a,L=Ja(i,i.VERTEX_SHADER,S),A=Ja(i,i.FRAGMENT_SHADER,E);i.attachShader(v,L),i.attachShader(v,A),e.index0AttributeName!==void 0?i.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function T(M){if(o.debug.checkShaderErrors){const D=i.getProgramInfoLog(v).trim(),R=i.getShaderInfoLog(L).trim(),N=i.getShaderInfoLog(A).trim();let F=!0,I=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(F=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(i,v,L,A);else{const Y=Qa(i,L,"vertex"),V=Qa(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
`;ki.innerHTML='<div id="hud-camera">camera: follow</div><div id="hud-speed">0 km/h</div><div style="margin-top:4px;opacity:0.6;font-size:10px;">ESC: menu · C: camera</div><div style="margin-top:2px;opacity:0.35;font-size:9px;">build 2026-05-11 14:10</div>';document.body.appendChild(ki);const Zv=ki.querySelector("#hud-camera"),Jv=ki.querySelector("#hud-speed"),tr={isStarted:()=>ai,setCameraMode:o=>{Zv.textContent=`camera: ${o}`},setSpeed:o=>{Jv.textContent=`${Math.round(o)} km/h`}};let ei=null,Yl=0;function Qv(o=!1){return o||new URLSearchParams(location.search).has("debug")?(ei=document.createElement("div"),ei.id="debug-panel",ei.style.cssText=`
